...
function calcOperation(number1, number2, operator) {
    ...
    if (arguments.length > 3){
        throw new Error("Error: Кількість аргументів не повинна бути більше 3-х")
    }
    if (typeof number1 != "number" || typeof number2 != "number") {
        throw new Error("Error: Для всіх операцій перший та другий параметр повинні бути числами");
    }
    switch (operator) {
        case "+":
        ...
        case "-":
            ...
            break;
        case "/":
            if (number2 == 0) throw new Error("Error: Коли операція ділення, другий параметр повинен не дорівнювати 0");
            result = number1 / number2;
            break;
        case "*":
            result = number1 * number2;
            break;
        default:
            throw new Error("Error: Третій параметр повинен бути рядком та дорівнювати одному із 4 значень : +-/*");
    }
    return`${number1} ${operator} ${number2} = ${result}`;
}

console.log(calcOperation(10, 1, "*"))
